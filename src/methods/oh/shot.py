...
def train_target(cfg):
    ...
    # if cfg.ISSAVE:   
    torch.save(netF.state_dict(), osp.join(cfg.output_dir, "target_F_"  + ".pt"))
    torch.save(netB.state_dict(), osp.join(cfg.output_dir, "target_B_"  + ".pt"))
    torch.save(netC.state_dict(), osp.join(cfg.output_dir, "target_C_"  + ".pt"))
